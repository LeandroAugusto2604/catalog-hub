                ...
                customerEmail
                  ? transporter.sendMail({
                      ...
                      html: wrap(`
                        ...
                        <p style="font-size:12px;color:#666;margin-top:24px">Pedido nº <strong>${shipData?.order?.order_number ?? orderId}</strong> — consulte o status em ${process.env.SITE_URL ?? "https://www.tudotoplartech.shop"}/meu-pedido</p>
                      `),
                    })
                  : Promise.resolve(),
                transporter.sendMail({
